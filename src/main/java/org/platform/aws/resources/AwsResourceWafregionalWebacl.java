 ...
 * Generated class
 */
public class AwsResourceWafregionalWebacl {

    /**
     * A friendly name or description for the Amazon CloudWatch metric of this web ACL. For valid values, see the MetricName parameter of the CreateWebACL action in the AWS WAF Regional API Reference. 
     */
